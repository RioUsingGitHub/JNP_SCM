...
<div class="container mx-auto px-4 py-8 max-w-5xl">
    ...
    <div class="grid md:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 p-6">
            <div class="flex items-center mb-4">
                <!-- SVG Icon -->
                <svg class="icon text-blue-500 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
                <!-- Text -->
                <h3 class="text-xl font-semibold text-gray-800">Sender Information</h3>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 p-6">
            <div class="flex items-center mb-4">
                <svg class="icon text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 p-6 mb-8">
        <div class="flex items-center mb-4">
            <svg class="icon text-purple-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 p-6">
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center">
                <svg class="icon text-orange-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
